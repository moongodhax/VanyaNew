            ...
            <div class="card my-4">
              ...
              <div class="card-body">
                <template v-for="stream in streams" >
                  ...
                  <label class="btn btn-outline-secondary btn-sm" v-bind:for="'streamCheck-' + stream.id" v-on:click="toggleStreamId(stream.id)">{{ stream.stream }}</label>
                </template>
                <div class="text-center">
              ...
              <div class="card-body">
                ...
                <template v-if="streams[selectedStream]">
                  <template v-for="substream in streams[selectedStream].substreams" >
                    ...
                    <label class="btn btn-outline-secondary btn-sm" v-bind:for="'substreamCheck-' + substream.id" v-on:click="toggleSubstreamId(substream.id)">{{ substream.name }}</label>
                  </template>
                </template>
